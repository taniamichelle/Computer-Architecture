...
- Make a list of files here.
  - cpu.py: contains the CPU class with the following methods: init(NOT implemented), load(implemented), alu(implemented), trace(implemented), run(NOT implemented)
  - ls8.py: imports cpu file, instantiates an instance of the CPU class, loads and runs cpu
